 ...
 $errormsg='';
   ...
   $error=$_FILES['upload']['error'];
	...
	if($formok){
         ...
         $sql2 = "INSERT INTO `summaries`(`sum_name`,file_name, `student_name`, `teacher_name`, `uinv_id`, `spe_id`, `level_id`, `term_id`, `foct_id`, `subject_id`,`size`,`type`,`date`)
        VALUES ('$sum_name','$name','$student_name','$teacher_name','$uinv_id','$spe_id','$level_id','$term_id','$foct_id','$subject_id','$size','$type','$date')";
  ...
  <div class="modal fade" id="e" role="dialog">
   ...
   <div id="page-wrapper" >
            ...
            <div id="page-inner">
                   ...
                   <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">رفع ملخص  
...
<div class="form-group col-md-12 ">
    ...
    <input type="text" class="form-control" id="sum_name" name="sum_name">
  </div>
                        <div class="form-group col-md-12 ">
