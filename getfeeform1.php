...
<?php
 if(isset($_POST['r']) && $_POST['r']=='video'){
$uinv_id=$_POST['uinv_id']; 
$subject_id=$_POST['subject_id'];
$spe_id=$_POST['spe_id'];
?>
...
<a href="#" onclick="" data-toggle="modal" data-target="#e">
   ...
   <p title="Delete" style="background: dimgray;"><a href="#" onclick="Delet(<?php echo $un['gre_id']; ?>)"    data-toggle="modal" data-target="#tooltip"    name="del" class="btn " >
      <span class="glyphicon glyphicon-trash"></span> حذف</a></p> 
