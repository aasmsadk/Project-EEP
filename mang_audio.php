...
if($_POST['submit'] && !empty($_FILES)){
   ...
   $error=$_FILES['upload']['error'];
	...
	$a=false;
        ...
        $type=$_POST['type'];
			echo "";
             echo "<div class='alert alert-danger alert-autocloseable-danger'>الملف المرفوع ليس ملف صوتي ,أعد المحاولة</div> ";
	...
	if($formok){
        ...
        $sql2 = "UPDATE `audio` SET `audio_name`='$audio_name',
        `name`='$name',
        `uinv_id`='$uinv_id',
        `foct_id`='$foct_id',
        `spe_id`='$spe_id',
  ...
  <div class="modal fade" id="e" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="display: flow-root;">
          ...
          <h4 class="modal-title">تعديل التسجيل</h4>
        </div>
   ...
   <div id="page-wrapper" >
            ...
            <div id="page-inner">
                   ...
                   <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">ادارة التسجيلات  
...
$query= "select * from  audio v, subject s, specialist p where v.subject_id=s.subject_id and v.spe_id=p.spe_id ";
