...
<?php  error_reporting(E_ALL ^ E_NOTICE);
 ...
 $errormsg='';
    ...
    if($_POST['submit'] && !empty($_FILES)){
        $dir_name=dirname(__FILE__)."/file/uploaded_vidoes/";
	...
	if(!is_uploaded_file($path)){
        ...
        echo $error;
			...
			echo $smsg= "	<div class='alert alert-warning alert-dismissible'>     
					...
					<strong>Sorry!</strong> الملف المرفوع ليس فيديو,أعد المحاولة . 
					</div>    " ;
...
$sql2 = "INSERT INTO `videos`( `vid_name`, `uinv_id`, `foct_id`, `spe_id`, `subject_id`, `level_id`, `term_id`, `date`, `type`,`size`,`name`) 
VALUES ('$vid_name','$uinv_id','$foct_id','$spe_id','$subject_id','$level_id','$term_id','$date','$type','$size','$name')";
mysqli_query($coon,$sql2);
        
        echo "<div class='alert alert-success alert-autocloseable-success'>تم أضافة الفيديو بنجاح </div> ";
  ...
  <div class="modal fade" id="e" role="dialog">
   ...
   <div id="page-wrapper" >
            ...
            <div id="page-inner">
                   ...
                   <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">رفع فيديو   
...
<div class="form-group col-md-12 ">
    ...
    <input type="text" class="form-control" id="vid_name" name="vid_name">
    		...
    		<span class="thumbnail">
      				<span class="thumbnail ">
                        <video controls style="width: 100%; height: 30%" >
